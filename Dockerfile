...
RUN apt-get -y install libpq-dev python-dev libxml2-dev libxslt1-dev libldap2-dev libsasl2-dev libffi-dev default-jdk
...
COPY .config.py /
COPY start-spark.sh /
ADD http://kickstart.slc.ere/ojdbc8.jar /opt/spark/jars
